//import favbookimg from assests
  ...
  return (
    <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="md:w-1/2">
            <img src="" alt="" className="rounded md:w-10/12"/>
        </div>
        <div className="md:w-1/2 space-y-6">
            ...
            <p className="mb-10 text-lg md:5/6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos, voluptates.</p>
